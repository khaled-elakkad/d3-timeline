(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? module.exports = factory(require('d3-axis'), require('d3-array'), require('d3-time-format'), require('d3-time'), require('d3-scale'), require('d3-selection'), require('d3-zoom')) :
  typeof define === 'function' && define.amd ? define(['d3-axis', 'd3-array', 'd3-time-format', 'd3-time', 'd3-scale', 'd3-selection', 'd3-zoom'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.d3 = global.d3 || {}, global.d3.timelines = factory(global.d3, global.d3, global.d3, global.d3, global.d3, global.d3, global.d3)));
})(this, (function (d3Axis, d3Array, d3TimeFormat, d3Time, d3Scale, d3Selection, d3Zoom) { 'use strict';
  				...
  				d.forEach( function(datum, index){
  					...
  					view.selectAll("svg")
  						...
  						.attr("cy", function(d, i) {
  								return getStackPosition() + itemHeight/2;
  						})
  						.attr("cx", getXPos)
  						.attr("r", itemHeight / 2)
  						.attr("height", itemHeight)
